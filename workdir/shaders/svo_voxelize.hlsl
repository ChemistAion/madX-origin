...
#define SVO_VoxelizeVS \
	"RootFlags(ALLOW_INPUT_ASSEMBLER_INPUT_LAYOUT),"\
	"CBV(b1, flags = DATA_STATIC, visibility = SHADER_VISIBILITY_VERTEX),"\
	"CBV(b7, flags = DATA_STATIC, visibility = SHADER_VISIBILITY_VERTEX)"
	
#define SVO_VoxelizePS \
	"RootFlags(ALLOW_INPUT_ASSEMBLER_INPUT_LAYOUT),"\
	"CBV(b0, flags = DATA_STATIC, visibility = SHADER_VISIBILITY_PIXEL),"\
	"DescriptorTable(SRV(t0), UAV(u1), UAV(u2), visibility = SHADER_VISIBILITY_PIXEL),"\
